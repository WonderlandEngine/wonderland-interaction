...
import {ControlsKeyboard} from 'wle-interaction';
import {ControlsVR} from 'wle-interaction';
import {InputBridge} from 'wle-interaction';
...
import {TeleportLocomotion} from 'wle-interaction';
...
const Constants = {
    ProjectName: 'player-controller.wlp',
...
engine.registerComponent(ControlsKeyboard);
engine.registerComponent(ControlsVR);
engine.registerComponent(InputBridge);
...
engine.registerComponent(TeleportLocomotion);
