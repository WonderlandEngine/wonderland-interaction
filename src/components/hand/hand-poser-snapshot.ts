import {Alignment, Component, Material, property, TextComponent, WonderlandEngine} from '@wonderlandengine/api';
import { HandTracking } from '@wonderlandengine/components';

import {Interactor} from '../interactor.js';
import {HandPoser} from './hand-poser.js';
...
export class HandPoserSnapshot extends Component {
    static TypeName = 'hand-poser-snapshot';
    ...
    onActivate() {
        const hand = this.object.getComponent(HandPoser)!;
        if(hand.skinRoot) {
